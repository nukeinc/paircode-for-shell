...
int main()
{
    ...
    // std::vector<double> energyp={-0.092 ,0.962  ,2.440,2.990, 2.763};
    ...
    std::cout<<"hamp1"<<std::endl;
    printMatrix(matslip);
    std::cout<<"hamp1ch"<<std::endl;
    ...
    catchpair2=generateValidPairs(6,rorderrn,50);
    std::vector<basis> allbasisn;
    allbasisn=calculateBasisWithRange(  6, catchpair2);

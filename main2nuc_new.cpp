//
// Created by 王恒毅 on 2025/12/18.
//
//
// Created by wang- on 25-12-18.
//
    ...
    if (userInput == 1)
    {
        ...
        if (transinput==1)
        {
            ...
            std::vector<Eigen::MatrixXd> doublemat=
                caldoublemat_sparse(result1.allbasisp1,result1.allbasism01,result1.allbasism11,
                result1.ystrm01_sp,result1.ystrm11_sp,result1.changemat01,result1.changemat11,
                result1.schmitmat1,result2.allbasisp1,result2.allbasism01,result2.allbasism11,
                result2.ystrm01_sp,result2.ystrm11_sp,result2.changemat01,result2.changemat11,
            ...
            std::vector<Eigen::MatrixXd> doublemat=
                ...
                result1.ystrm02_sp, result1.ystrm12_sp, result1.changemat02, result1.changemat12,
                result1.schmitmat2,
                result2.allbasisp2, result2.allbasism02, result2.allbasism12,
                result2.ystrm02_sp, result2.ystrm12_sp, result2.changemat02, result2.changemat12,
                result2.schmitmat2,
                rvec, transtrvec
            );

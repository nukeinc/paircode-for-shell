...
int main()
{
    ...
    std::vector<std::vector<int>>rorderrp={rorderp,{20,20}};
    std::vector<std::pair<std::vector<int>, std::vector<int>>> catchpair1;
    catchpair1=generateValidPairs(8,rorderrp,51);
    std::vector<basis> allbasisp;
    allbasisp=calculateBasisWithRange(  8, catchpair1);
    ...
    std::vector<double> energyp={-3.00};
    std::vector<std::vector<double>> matslip;
    std::vector<double> ktp={-0.30};
    std::vector<double> gsp={-0.65,-0.20};
    ...
    schmitmatp=gramSchmidtInOverlap(overlapp);
    ...
    schmitmatn=gramSchmidtInOverlap(overlapn);
    schmitmatn=Zmatrixn;

...
int main()
{
    ...
    //     {0, 0, 1, 1},
    // };
    ystrgetp = readstrfile("D:/paircalpro/mschemecode/strfilesd.txt");
...
// std::cout<<ystrm1[0][1]<<std::endl;
    ...
    std::vector<DataRow> V1val1;
    std::ifstream input_file("D:/paircalpro/mschemecode/efc1usda.txt"); // 替换为你的文件名
    ...
    std::vector<std::map<int, Matrix4D>>buildVValue2= processFile("D:/paircalpro/mschemecode/efc1usda.txt");

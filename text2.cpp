...
int main()
{
    ...
    std::vector<int> rorderp={0,4,8,12,16,6};
    std::vector<std::vector<int>>rorderrp={rorderp,{0,99,0,1},{0,1,2,3,4,5}};
    ...
    std::vector<DataRow> V1val1;
    std::ifstream input_file("D:/paircalpro/mschemecode/efct1copy.txt"); // 替换为你的文件名
    ...
    std::vector<std::map<int, Matrix4D>>buildVValue2= processFile("D:/paircalpro/mschemecode/efct1copy.txt");
    ...
    std::vector<double>strength={1.0,0.57};
    ...
    std::vector<double> energyp={1.35292300 ,    -1.08623249 ,     1.69663730   ,   0.47103342    ,  1.27303342,1.13244657};
